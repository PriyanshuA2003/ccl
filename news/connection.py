...
business="CREATE TABLE business( business_id int(11) NOT NULL, business_count int(11) NOT NULL, business_date date NOT NULL) "
mycursor.execute(business)

business_sub="CREATE TABLE business_subcategory (buss_sub_id int(11) NOT NULL,Crypto int(11) NOT NULL,Market int(11) NOT NULL,Money int(11) NOT NULL,Economy int(11) NOT NULL,Industry int(11) NOT NULL,Date date NOT NULL)"
